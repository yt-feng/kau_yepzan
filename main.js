...
const PRODUCTS = {
  ...
  practice: {
    ...
    description: 'A goal-based practice shell with learning materials and WhatsApp support when you get stuck. Content and access rules will be published with the KAU release.',
  ...
  bundle: {
    ...
    description: 'The recommended path for serious beginners: foundations first, then guided practice. The course bundle will be activated after the KAU content is uploaded.',
...
const COPY = {
  en: {
    ...
    navHome: 'Home', navLearn: 'Short videos', navProducts: 'Courses', navCheckout: 'Checkout', navContact: 'Contact', langLabel: 'Language', productCta: 'Ask about this', inquiryButton: 'Send inquiry', lessonCountLabel: 'lessons ready',
